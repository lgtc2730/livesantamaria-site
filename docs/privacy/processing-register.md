...
Responsável técnico e operacional: Luis Carreiro, em nome individual (não é Encarregado de Proteção de Dados).  
...
| Fundamento proposto | Interesse legítimo, sujeito à ponderação documentada e aprovação de Luis Mesquita. |
...
| Revisão/aprovador | Revisão por câmara e após incidente; Luis Mesquita. **Pendente de aprovação do responsável — não publicar em produção**. |
...
| Destinatários/operadores | Luis Mesquita e Luis Carreiro para resultados; Cloudflare Pages/Functions/D1 como infraestrutura técnica. |
...
| Revisão/aprovador | Antes de produção e após mudança de métrica/fornecedor; Luis Mesquita. **Pendente de aprovação do responsável — não publicar em produção**. |
...
| Destinatários/operadores | Luis Mesquita e Luis Carreiro conforme necessidade; Google/Gmail como fornecedor da conta do projeto. |
...
| Revisão/aprovador | Semestral e após mudança de conta/acessos; Luis Mesquita. **Pendente de aprovação do responsável — não publicar em produção**. |
...
| Destinatários/operadores | Luis Carreiro; Luis Mesquita quando necessário; fornecedores de infraestrutura aplicáveis. |
...
| Revisão/aprovador | Após incidente e pelo menos anual; Luis Mesquita. **Pendente de aprovação do responsável — não publicar em produção**. |
